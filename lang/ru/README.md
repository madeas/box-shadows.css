...
> Версия v1.0.5 стала намного проще, поскольку поддержка префикса больше не требуется. Чтобы проверить это, проверьте поддержку своего браузера на сайте [Can I Use][caniuse]
