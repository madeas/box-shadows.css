...
## Содержание
* [Применение](#basic-usage)
	- [Подключение стилей](#1-include-the-stylesheet)
	- [Добавление класса](#2-add-the-class)
	- [Добавление класса с номером](#3-add-the-class-number)
	- [Эффекты при наведении](#4-hover-effect)
	- [Плавная трансформация](#5-animation-on-css-transform)
	- [Добавление параметра inset](#6-adding-the-inset-parameter)
* [WordPress Function.php](#wordpress-functionphp)
* [Геренатор css файлов min.css](#generator-the-file-box-shadowsmincss)
* [Генератор css box-shadow](#box-shadow-css-generator)
* [Использование](#usage)
* [Лицензия](#license)
...
<p align="right"><a href="#content">↑ наверх</a></p>
